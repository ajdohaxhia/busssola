    ...
    lessons: [
        {
            ...
            learningGoals: [
                'Collega prove digitali, screenshot e segnalazioni a esempi normali, non solo a casi estremi.',
...
prove digitali, screenshot e segnalazioni entra nella vita di tutti i giorni molto più di quanto sembri. Questa lezione collega il tema a situazioni concrete, mostra perché conta davvero e prepara il terreno per scelte più sicure senza allarmismi.
...
`
        ...
        {
            id: '2',
            title: 'Parole chiave di prove digitali, screenshot e segnalazioni',
            minutes: 5,
            difficulty: 'base',
            audienceTag: 'tutti',
            moduleTag: 'Prove digitali, screenshot e segnalazioni',
            ...
            contentMarkdown: `### Sintesi
Prima di agire bene serve un vocabolario minimo. Qui spieghi parole, funzioni e differenze utili per leggere meglio impostazioni, avvisi e richieste legate a prove digitali, screenshot e segnalazioni.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Chi legge deve poter fare subito qualcosa di utile. Trasforma la teoria in un primo controllo pratico, semplice e realistico, così prove digitali, screenshot e segnalazioni smette di sembrare astratto.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
prove digitali, screenshot e segnalazioni cambia quando entra in gioco una famiglia, una classe, un gruppo o una chat comune. Qui mostri come le scelte individuali influenzano anche gli altri.
...
`
        ...
        {
            id: '15',
            title: 'prove digitali, screenshot e segnalazioni su app e piattaforme',
            minutes: 5,
            difficulty: 'intermedia',
            audienceTag: 'tutti',
            moduleTag: 'Prove digitali, screenshot e segnalazioni',
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Un esercizio pratico rende il modulo attivo e memorabile. Fai fare un controllo reale, una modifica concreta o una breve simulazione collegata a prove digitali, screenshot e segnalazioni.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Il ripasso finale chiude il modulo con ordine. Riassumi i concetti chiave, collega prove digitali, screenshot e segnalazioni ad altri temi Busssola e indica il passo successivo migliore.
