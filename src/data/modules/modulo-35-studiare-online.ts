    ...
    lessons: [
        {
            ...
            learningGoals: [
                'Collega studiare online senza farsi fregare a esempi normali, non solo a casi estremi.',
...
studiare online senza farsi fregare entra nella vita di tutti i giorni molto più di quanto sembri. Questa lezione collega il tema a situazioni concrete, mostra perché conta davvero e prepara il terreno per scelte più sicure senza allarmismi.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Prima di agire bene serve un vocabolario minimo. Qui spieghi parole, funzioni e differenze utili per leggere meglio impostazioni, avvisi e richieste legate a studiare online senza farsi fregare.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Chi legge deve poter fare subito qualcosa di utile. Trasforma la teoria in un primo controllo pratico, semplice e realistico, così studiare online senza farsi fregare smette di sembrare astratto.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
studiare online senza farsi fregare cambia quando entra in gioco una famiglia, una classe, un gruppo o una chat comune. Qui mostri come le scelte individuali influenzano anche gli altri.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Un esercizio pratico rende il modulo attivo e memorabile. Fai fare un controllo reale, una modifica concreta o una breve simulazione collegata a studiare online senza farsi fregare.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Il ripasso finale chiude il modulo con ordine. Riassumi i concetti chiave, collega studiare online senza farsi fregare ad altri temi Busssola e indica il passo successivo migliore.
