    ...
    lessons: [
        {
            ...
            learningGoals: [
                'Collega social media: impostazioni e confini a esempi normali, non solo a casi estremi.',
...
social media: impostazioni e confini entra nella vita di tutti i giorni molto più di quanto sembri. Questa lezione collega il tema a situazioni concrete, mostra perché conta davvero e prepara il terreno per scelte più sicure senza allarmismi.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Prima di agire bene serve un vocabolario minimo. Qui spieghi parole, funzioni e differenze utili per leggere meglio impostazioni, avvisi e richieste legate a social media: impostazioni e confini.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Chi legge deve poter fare subito qualcosa di utile. Trasforma la teoria in un primo controllo pratico, semplice e realistico, così social media: impostazioni e confini smette di sembrare astratto.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
social media: impostazioni e confini cambia quando entra in gioco una famiglia, una classe, un gruppo o una chat comune. Qui mostri come le scelte individuali influenzano anche gli altri.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Un esercizio pratico rende il modulo attivo e memorabile. Fai fare un controllo reale, una modifica concreta o una breve simulazione collegata a social media: impostazioni e confini.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Il ripasso finale chiude il modulo con ordine. Riassumi i concetti chiave, collega social media: impostazioni e confini ad altri temi Busssola e indica il passo successivo migliore.
