...
export const modulo_45_cloud_backup : Module = {
    id: 'modulo-45-cloud-backup',
    title: 'Modulo 45: Cloud, backup e recupero dati',
    description: 'Proteggi foto, documenti e ricordi digitali con backup ordinati, accessi sicuri e recupero consapevole.',
    category: 'SKILL',
    ...
    lessons: [
        {
            id: '1',
            title: 'Capire cloud, backup e recupero dati',
            minutes: 5,
            difficulty: 'base',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
            learningGoals: [
                'Comprendere il punto chiave di cloud, backup e recupero dati senza allarmismi.',
...
Questa lezione mette a fuoco cloud, backup e recupero dati con parole semplici e senza allarmismi. La sicurezza digitale funziona meglio quando hai pochi passaggi chiari, ripetibili e realistici.
...
### Passo pratico
Scrivi in una frase cosa significa per te cloud, backup e recupero dati e quale dubbio vuoi chiarire per primo.`
        },
        {
            id: '2',
            title: 'Parole chiave di cloud, backup e recupero dati',
            minutes: 5,
            difficulty: 'base',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
...
Scrivi in una frase cosa significa per te cloud, backup e recupero dati e quale dubbio vuoi chiarire per primo.`
        ...
        {
            id: '3',
            title: 'Errori comuni in cloud, backup e recupero dati',
            minutes: 5,
            difficulty: 'base',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
...
Scegli un errore che rischieresti di fare sotto stress e scrivi l’azione alternativa.`
        ...
        {
            id: '4',
            title: 'Primo check pratico su cloud, backup e recupero dati',
            minutes: 5,
            difficulty: 'base',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
            ...
            contentMarkdown: `### Perché conta
In una situazione legata a cloud, backup e recupero dati, l’ordine delle azioni conta più della quantità di cose fatte. La sicurezza digitale funziona meglio quando hai pochi passaggi chiari, ripetibili e realistici.
...
### Passo pratico
Apri l’app più legata a cloud, backup e recupero dati e controlla una sola impostazione di privacy oggi.`
        },
        {
            id: '6',
            ...
            contentMarkdown: `### Perché conta
Questa lezione collega cloud, backup e recupero dati a decisioni concrete che puoi prendere nella vita quotidiana. La sicurezza digitale funziona meglio quando hai pochi passaggi chiari, ripetibili e realistici.
...
### Passo pratico
Applica oggi un controllo concreto legato a cloud, backup e recupero dati e annota cosa hai cambiato.`
        },
        {
            id: '7',
            ...
            moduleTag: 'Cloud, backup e recupero dati',
            learningGoals: [
                'Riconoscere segnali osservabili legati a cloud, backup e recupero dati.',
...
### Passo pratico
Scegli tre segnali che per te indicano un limite superato in tema cloud, backup e recupero dati.`
        },
        {
            id: '8',
...
Applica oggi un controllo concreto legato a cloud, backup e recupero dati e annota cosa hai cambiato.`
        ...
        {
            id: '14',
            title: 'cloud, backup e recupero dati in famiglia, a scuola o in gruppo',
            minutes: 5,
            difficulty: 'intermedia',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
            ...
            contentMarkdown: `### Perché conta
Cloud, backup e recupero dati cambia quando coinvolge famiglie, classi o gruppi: servono linguaggio calmo e responsabilità condivisa. La sicurezza digitale funziona meglio quando hai pochi passaggi chiari, ripetibili e realistici.
...
Prepara tre frasi calme: cosa sappiamo, cosa non sappiamo, cosa facciamo ora.`
        ...
        {
            id: '15',
            title: 'cloud, backup e recupero dati su app e piattaforme',
            minutes: 5,
            difficulty: 'intermedia',
            audienceTag: 'tutti',
            moduleTag: 'Cloud, backup e recupero dati',
...
Applica oggi un controllo concreto legato a cloud, backup e recupero dati e annota cosa hai cambiato.`
        },
        {
            ...
            contentMarkdown: `### Perché conta
Il ripasso serve a trasformare cloud, backup e recupero dati in abitudini, non in nozioni da dimenticare. La sicurezza digitale funziona meglio quando hai pochi passaggi chiari, ripetibili e realistici.
