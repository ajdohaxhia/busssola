    ...
    lessons: [
        {
            ...
            learningGoals: [
                'Collega casa connessa: smart device e privacy a esempi normali, non solo a casi estremi.',
...
casa connessa: smart device e privacy entra nella vita di tutti i giorni molto più di quanto sembri. Questa lezione collega il tema a situazioni concrete, mostra perché conta davvero e prepara il terreno per scelte più sicure senza allarmismi.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Prima di agire bene serve un vocabolario minimo. Qui spieghi parole, funzioni e differenze utili per leggere meglio impostazioni, avvisi e richieste legate a casa connessa: smart device e privacy.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Chi legge deve poter fare subito qualcosa di utile. Trasforma la teoria in un primo controllo pratico, semplice e realistico, così casa connessa: smart device e privacy smette di sembrare astratto.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
casa connessa: smart device e privacy cambia quando entra in gioco una famiglia, una classe, un gruppo o una chat comune. Qui mostri come le scelte individuali influenzano anche gli altri.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Un esercizio pratico rende il modulo attivo e memorabile. Fai fare un controllo reale, una modifica concreta o una breve simulazione collegata a casa connessa: smart device e privacy.
...
`
        },
        {
            ...
            contentMarkdown: `### Sintesi
Il ripasso finale chiude il modulo con ordine. Riassumi i concetti chiave, collega casa connessa: smart device e privacy ad altri temi Busssola e indica il passo successivo migliore.
