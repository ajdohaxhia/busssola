...
export const m1: ModuleContent = {
    ...
    game: {
        type: 'chat',
        objective: 'Identifica il tentativo di Grooming e blocca il predatore prima che sia troppo tardi.',
        data: {
            initialMessage: "Ehi! Ho visto che sei nel gruppo di Fortnite. Sei fortissimo! Quanti anni hai?",
            nodes: {
                'root': {
                    text: "Ehi! Ho visto che sei nel gruppo di Fortnite. Sei fortissimo! Quanti anni hai?",
                    sender: 'bot',
                    options: [
                        { label: "Grazie! Ho 14 anni, tu?", nextId: 'age-reply', score: 0 },
                        { label: "Chi sei scusa?", nextId: 'defensive', score: 10 } // Better boundary
                    ]
                },
                'age-reply': {
                    text: "Io ne ho 16. Sembri molto più maturo per la tua età però. I tuoi genitori ti lasciano giocare quanto vuoi o rompono?",
                    sender: 'bot',
                    options: [
                        { label: "Rompono sempre, non mi capiscono.", nextId: 'isolation', score: -10 },
                        { label: "Ho le mie regole. Ma chi sei?", nextId: 'defensive', score: 10 }
                    ]
                },
                'defensive': {
                    text: "Tranquillo, sono solo un fan! Volevo solo fare amicizia. Mi sento un po' solo ultimamente, nessuno mi capisce come sembri fare tu...",
                    sender: 'bot',
                    options: [
                        { label: "Mi dispiace. Vuoi fare una partita?", nextId: 'game-invite', score: 5 },
                        { label: "Blocca utente", nextId: 'block-early', score: 50 }
                    ]
                },
                'isolation': {
                    text: "Lo sapevo. Gli adulti non capiscono niente di noi. Senti, ma hai Instagram o Telegram? Qui non posso parlare liberamente...",
                    sender: 'bot',
                    options: [
                        { label: "Sì, ti aggiungo.", nextId: 'fail-platform', score: -50 },
                        { label: "No, parliamo qui o niente.", nextId: 'boundary-set', score: 20 }
                    ]
                },
                'fail-platform': {
                    text: "Ottimo. Ti scrivo di là. (Il predatore ha ottenuto accesso al tuo profilo privato. GAME OVER)",
                    sender: 'bot',
                    isEnding: true,
                    feedback: "Mai spostare la conversazione su un canale privato con uno sconosciuto. È la tattica numero 1 per isolarti."
                },
                'boundary-set': {
                    text: "Uff, sei noioso. Va bene ciao. (L'utente si è disconnesso)",
                    sender: 'bot',
                    isEnding: true,
                    feedback: "Ottimo lavoro! I predatori cercano prede facili. Se metti confini chiari ('boundary'), spesso desistono e cercano altrove."
                },
                'block-early': {
                    text: "(Utente Bloccato)",
                    sender: 'user',
                    isEnding: true,
                    feedback: "Perfetto! Non hai obbligo di essere gentile con sconosciuti sospetti. Fidati del tuo istinto."
                },
                'game-invite': {
                    text: "Magari dopo. Senti, ma mi mandi una foto? Voglio vedere che faccia ha un campione.",
                    sender: 'bot',
                    options: [
                        { label: "Assolutamente no.", nextId: 'boundary-set', score: 20 },
                        { label: "Ok ma solo faccia.", nextId: 'photo-sent', score: -30 }
                    ]
                },
                'photo-sent': {
                    text: "Carino/a! Senti... fa caldo lì? Scommetto che staresti meglio senza maglietta...",
                    sender: 'bot',
                    isEnding: true,
                    feedback: "Hai visto quanto velocemente è scalato? Dai complimenti alla richiesta di foto. Mai mandare foto a sconosciuti."
                }
            }
        }
    }
